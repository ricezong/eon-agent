package cn.kong.eon.agent.guard;
...
public class ToolCircuitBreaker {
    ...
    public ToolCircuitBreaker(AgentConfig.LoopDetectConfig cfg) {
        this(cfg.getFailureWarn(), cfg.getFailureStop(), cfg.getCooldownTurns());
    }

    public ToolCircuitBreaker(int warnThreshold, int stopThreshold, int cooldownTurns) {
